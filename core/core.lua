...
LSM:Register("sound", "Priority3", [[Interface\AddOns\Biddikus\media\sound\tsbgrip.ogg]])
...
LSM:Register("sound", "Priority10", [[Interface\AddOns\Biddikus\media\sound\tsbwhale.ogg]])
LSM:Register("sound", "Priority11", [[Interface\AddOns\Biddikus\media\sound\beanwtflim.ogg]])
LSM:Register("sound", "Priority12", [[Interface\AddOns\Biddikus\media\sound\beanhappening.ogg]])
...
LSM:Register("sound", "Priority15", [[Interface\AddOns\Biddikus\media\sound\sqdontknow.ogg]])
LSM:Register("sound", "Priority16", [[Interface\AddOns\Biddikus\media\sound\limbeanmule.ogg]])
LSM:Register("sound", "Priority17", [[Interface\AddOns\Biddikus\media\sound\xel3.ogg]])
LSM:Register("sound", "Priority18", [[Interface\AddOns\Biddikus\media\sound\limhappy.ogg]])
...
LSM:Register("sound", "Priority21", [[Interface\AddOns\Biddikus\media\sound\xeldeadlim.ogg]])
...
LSM:Register("sound", "Priority24", [[Interface\AddOns\Biddikus\media\sound\beanbiddikus.ogg]])
...
LSM:Register("sound", "Priority28", [[Interface\AddOns\Biddikus\media\sound\tsbshart.ogg]])
...
LSM:Register("sound", "Priority32", [[Interface\AddOns\Biddikus\media\sound\YEP.ogg]])
LSM:Register("sound", "Priority33", [[Interface\AddOns\Biddikus\media\sound\beandruid.ogg]])
LSM:Register("sound", "Priority34", [[Interface\AddOns\Biddikus\media\sound\maczdi.ogg]])
...
function Biddikus:UpdateFrame()
    ...
    if self:CheckIfMasterLooter() then
        ...
        frame.footer.cp:SetSize(C.frame.width + 2, C.bar.height + 3)
        frame.footer.cp:SetPoint("BOTTOMLEFT", frame.footer, "BOTTOMLEFT", 0, -C.bar.height-3)
        frame.footer.cp.bg:SetAllPoints()
        frame.footer.cp.bg:SetVertexColor(unpack(C.frame.color))
        frame.footer.cp.copybox:SetSize(C.frame.width -6, C.bar.height)
        frame.footer.cp.copybox:SetPoint("TOPLEFT", frame.footer.cp, "TOPLEFT", 3, 0)
        frame.footer.cp.copybox:SetFont(LSM:Fetch("font", C.font.name), C.font.size, C.font.style)
...
function Biddikus:SetupFrame()
    ...
    self.frame.bidbox:SetScript("OnTabPressed", EditBox_ClearFocus)
    self.frame.bidbox:SetScript("OnSpacePressed", EditBox_ClearFocus)
    ...
    self.frame.footer.cp = CreateFrame("Frame", nil, self.frame.footer)

    self.frame.footer.cp.bg = self.frame.footer.cp:CreateTexture(nil, "BACKGROUND", nil, -8)
    self.frame.footer.cp.bg:SetColorTexture(1, 1, 1, 1)

    self.frame.footer.cp.copybox = CreateFrame("EditBox", "CopyBox", self.frame.footer)
    self.frame.footer.cp.copybox:SetMovable(false)
    self.frame.footer.cp.copybox:SetAutoFocus(false)
    self.frame.footer.cp.copybox:SetMultiLine(false)
    self.frame.footer.cp.copybox:SetScript("OnEnterPressed", EditBox_ClearFocus)
    self.frame.footer.cp.copybox:SetScript("OnEscapePressed", EditBox_ClearFocus)
    self.frame.footer.cp.copybox:SetScript("OnTabPressed", EditBox_ClearFocus)
    self.frame.footer.cp.copybox:SetScript("OnSpacePressed", EditBox_ClearFocus)
    self.frame.footer.cp.copybox:SetScript("OnEditFocusLost", EditBox_ClearHighlight)
    self.frame.footer.cp.copybox:SetScript("OnEditFocusGained", EditBox_HighlightText)
    CreateBackdrop(self.frame.footer.cp.copybox, C.backdrop)
...
function Biddikus:ClearBid()
    ...
    self.frame.footer.cp.copybox:SetText("")
    self:UpdateFrame()
end
